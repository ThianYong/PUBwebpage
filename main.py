...
st.sidebar.title("PLC CPU Data Entry")
...
# Set the main body title
st.title("Trends in PLC CPU Prices")

# Display the entered data in a table in the main body
st.subheader("Entered Data:")
st.table(data)

# Select brand and model for trend plotting in the main body
...
# Plot the trend of price changes for the selected brand and model using native Streamlit line chart in the main body
